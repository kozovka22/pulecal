...
use Pulecal\Service\Service\{EventService, CalendarService, UserService};
 ...
 */
#[AsController()]
#[Route(path:"/unlink", name:"eventUnlink")]

class UnlinkAction extends AbstractAction {
    ...
    public function call(Request $request) : JsonResponse {
        ...
        $event = $this->eventService->unlinkEvent($event, $calendar, $currentUser);
        return new JsonResponse([
            "status" => "success", 
            "data" => ["id" => $event->getId()]
        ], 200);
